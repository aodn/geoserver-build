...
<prov:document
    ...
    <prov:entity prov:id="WPS-Aggregator Dataset UID">
        ...
        <prov:location>${aggregatedDataUrl}</prov:location>
    ...
    <prov:entity prov:id="WPSQuery">
        <aodnprov:wpsQuery>
            <wps:Data>
                <LiteralData>${wpsQuery}</LiteralData>
            </wps:Data>
        </aodnprov:wpsQuery>
    ...
    <prov:entity prov:id="outputAggregationSettings">
        <!-- location is the URL of the NetCDF Aggregation settings (index reader, download and aggregation templates) file for this WPS job. -->
        <prov:location>${outputAggregationSettingsXml}</prov:location>
        <!-- prov:type is Mandatory -->
    ...
    <prov:entity prov:id="processingStatistics">
        <!-- location is the URL of the file generated by this WPS job that records: feature type instance processing statistics/input data-->
